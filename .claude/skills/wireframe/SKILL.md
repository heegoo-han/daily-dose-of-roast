...
와이어프레임은 Unicode box-drawing 문자를 사용하여 **시각적으로 렌더링**합니다. `[Button: label]`, `[Input: placeholder]` 같은 시맨틱 레이블은 사용하지 않습니다.
...
1. **너비**: Desktop 90자, Mobile 30자. DESIGN.md Responsive Strategy의 Platform에 따라 판별
...
3. Type은 DESIGN.md에 정의된 컴포넌트명 사용 (Button, Card, Input, Badge, Select, AlertDialog 등)
